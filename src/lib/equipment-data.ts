...
export const EXTRACTION_STATS = {
  ...
  successRate: "100%",
  brandsIdentified: 5,
  uniqueBrands: ["Whirlpool", "Hayward", "Speck Pumps", "Watkins", "CoverLogix"],
  equipmentTypes: ["Pool Pump", "Salt Cell", "Hot Tub / Spa", "Pool Safety Cover", "Appliance", "Dishwasher", "Refrigerator"],
  apiCost: "$0.08",
